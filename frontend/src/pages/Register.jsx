...
const Register = () => {
  ...
  return (
    <div className="lg:h-[83vh] h-full lg:mt-8 lg:pb-8 bg-gray-50 dark:bg-gray-900 flex flex-col lg:flex-row items-center justify-center py-2 lg:py-4 px-4 text-gray-900 dark:text-gray-100 overflow-hidden">
      {/* Left Side - Branding */}
